 ...
 */
import { AutomationPlaybookRunsService } from '../../../apps/api/src/projects/automation-playbook-runs.service';
import { AutomationPlaybookRunProcessor } from '../../../apps/api/src/projects/automation-playbook-run.processor';

// Mock the queue to simulate dev mode (no Redis)
jest.mock('../../../apps/api/src/queues/queues', () => ({
