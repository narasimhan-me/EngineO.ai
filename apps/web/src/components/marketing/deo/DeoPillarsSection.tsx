    ...
    <section className="border-b border-slate-100 bg-slate-50/60">
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <p className="mt-3 text-sm text-slate-600">DEO consists of four core pillars:</p>
        </div>
        <dl className="mt-6 grid gap-6 text-sm text-slate-600 sm:grid-cols-2">
          <div>
            <dt className="text-sm font-semibold text-slate-900">1. Content Quality</dt>
          ...
          <div>
            <dt className="text-sm font-semibold text-slate-900">3. Technical Health</dt>
            <dd className="mt-1">Crawlability, status codes, indexability, metadata presence.</dd>
          </div>
          <div>
            <dt className="text-sm font-semibold text-slate-900">4. Visibility Strength</dt>
            <dd className="mt-1">
